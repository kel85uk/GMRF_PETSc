...
PCG=( hypre icc ilu sor )
SOLVER=( fgmres bcgs symmlq cgne )
...
do
        # set the job name
        NAME="Test5_${PCG1}_${SOLVER1}_32SLMC1_500x500_150s"
        ...
        mpirun -np 32 --report-bindings --bind-to-core ./Test5 -ppc 1 -mat_type seqaij -vec_type seq -Nsamples 150 -m 500 -n 500 -pc_type ${PCG1} -pc_factor_levels 0 -pc_sor_its 200 -pc_sor_omega 1.8 -ksp_type ${SOLVER1} -dim 2 -alpha 2 -lamb 0.1 -sigma 0.3 -TOL 1e-10"
