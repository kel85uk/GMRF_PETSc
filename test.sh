...
do
        SIG="${SIG1}.${SIG2}"
        # set the job name
        NAME="Test5_L${LAM}_S${SIG}_32SLMC1_500x500_2000s"
        ...
        mpirun -np 32 --report-bindings --bind-to-core ./Test5 -mat_type seqaij -vec_type seq -Nsamples 2000 -m 500 -n 500 -pc_type hypre -ksp_type fgmres -dim 2 -alpha 2 -lamb ${LAM} -sigma ${SIG} -TOL 1e-10"
